---
description: >-
  This is a list of level editors for servers where you can publish your own
  chart! Download/website editor links included below!
icon: pen
---
...
{% hint style="info" %}
Three versions of MikuMikuWorld was provided in case if someone have compatibility issues with newer versions of MMW. If you have older version of MMW on your PC/Mobile stored please consider sharing it with us so we would help others :pray:\
Contact us: Open a ticket in [UntitledCharts](https://discord.gg/untitledcharts) or DM `_notfallen_` in Discord, thank you!
{% endhint %}
...
1. <img src="https://beatconnect.io/favicon.ico" alt="" data-size="line"> osu!taiko: comes from [https://beatconnect.io](https://beatconnect.io)
2. <img src="https://beatconnect.io/favicon.ico" alt="" data-size="line"> osu!mania: comes from [https://beatconnect.io](https://beatconnect.io)

{% hint style="info" %}
To create your charts for osu!taiko or osu!mania you need to login on the website, and create your chart from osu in-built editor (need to download [osu!](https://osu.ppy.sh/home/download)), after you finish it export it, and publish it in BeatConnect so it would show in Sonolus.
{% endhint %}
